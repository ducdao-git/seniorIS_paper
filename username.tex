...
\title{An Exploration Into Image Segmentation}
...
% \begin{abstract}
% Put your abstract text here -- Duc
% \end{abstract}
...
% This command forces all the bibliography references to be printed -- not just those that were explicitly cited in the text.  If you comment this out, the bibliography will only include cited references.
% \nocite{*}
